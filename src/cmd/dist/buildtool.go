...
func bootstrapBuildTools() {
	...
	// 注意这里GOROOT设置为/usr/lib/go，也就是用系统的runtime和标准库，只有toolchain命令本身
	// 的实现用需要编译版本的代码
...
// 在文件开始增加说明，同时重写import路径为 "xxx" => "bootstrap/xxx"
// 特别注意: 会写入//line src_file:1 导致gopls不能正常工作
//
// The line directive is a historical special case; all other directives are of the form //go:name,
// indicating that they are defined by the Go toolchain.
